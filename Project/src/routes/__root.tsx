...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EventHub is a premium event management platform. Discover events, book tickets, and manage your own — all in one place." },
      { name: "author", content: "Ali Muhammad" },
      { property: "og:title", content: "EventHub — Discover, Create and Manage Events" },
      { property: "og:description", content: "Discover, create and manage events effortlessly." },
